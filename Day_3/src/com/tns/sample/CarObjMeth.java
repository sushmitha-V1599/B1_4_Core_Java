...
public class CarObjMeth 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("The Car "+m.brand+" "+"has"+m.color+" for its body.");
		System.out.println("The Car "+b.brand+" "+"has"+b.color+" for its body.");
		System.out.println("The Car "+a.brand+" "+"has"+a.color+" for its body.");
	}
